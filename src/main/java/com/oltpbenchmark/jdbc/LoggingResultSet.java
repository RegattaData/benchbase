...
class LoggingResultSet implements ResultSet {
  ...
  public boolean next() throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_NEXT_1", System.nanoTime() - start, sql);
    }
  }
  ...
  public String getString(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_STRING", System.nanoTime() - start, sql);
    }
  }
  ...
  public boolean getBoolean(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_BOOL", System.nanoTime() - start, sql);
    }
  }
  ...
  public byte getByte(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_BYTE", System.nanoTime() - start, sql);
    }
  }
  ...
  public short getShort(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_SHORT", System.nanoTime() - start, sql);
    }
  }
  ...
  public int getInt(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_INT", System.nanoTime() - start, sql);
    }
  }
  ...
  public long getLong(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_LONG", System.nanoTime() - start, sql);
    }
  }
  ...
  public float getFloat(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_FLOAT", System.nanoTime() - start, sql);
    }
  }
  ...
  public double getDouble(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_DOUBLE", System.nanoTime() - start, sql);
    }
  }
  ...
  public BigDecimal getBigDecimal(int c, int s) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_BD", System.nanoTime() - start, sql);
    }
  }
  ...
  public byte[] getBytes(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_BYTES", System.nanoTime() - start, sql);
    }
  }
  ...
  public Date getDate(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_DATE", System.nanoTime() - start, sql);
    }
  }
  ...
  public Time getTime(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_TIME", System.nanoTime() - start, sql);
    }
  }
  ...
  public Timestamp getTimestamp(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_TIMESTAMP", System.nanoTime() - start, sql);
    }
  }
  ...
  public InputStream getAsciiStream(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic(
          "RS_GET_ASCII_STREAM", System.nanoTime() - start, sql);
    }
  }
  ...
  public InputStream getUnicodeStream(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic(
          "RS_GET_UNI_STREAM", System.nanoTime() - start, sql);
    }
  }
  ...
  public InputStream getBinaryStream(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic(
          "RS_GET_BIN_STREAM", System.nanoTime() - start, sql);
    }
  }
  ...
  public ResultSetMetaData getMetaData() throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("METADATA_FETCH", System.nanoTime() - start, sql);
    }
  }
  ...
  public Object getObject(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_OBJ", System.nanoTime() - start, sql);
    }
  }
  ...
  public Ref getRef(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_REF", System.nanoTime() - start, sql);
    }
  }
  ...
  public Blob getBlob(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_BLOB", System.nanoTime() - start, sql);
    }
  }
  ...
  public Clob getClob(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_CLOB", System.nanoTime() - start, sql);
    }
  }
  ...
  public Array getArray(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_ARRAY", System.nanoTime() - start, sql);
    }
  }
  ...
  public URL getURL(int c) throws SQLException {
    ...
    try {
      ...
      LoggingPreparedStatement.writeEventPublic("RS_GET_URL", System.nanoTime() - start, sql);
    }
  }
